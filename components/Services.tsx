  ...
  const services = [
    {
      ...
      description:
        "Explore beautiful underwater worlds with guided recreational diving experiences for all skill levels.",
      icon: (
        <svg
          className="w-12 h-12"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Capture stunning underwater moments with professional photography services during your dive.",
      icon: (
        <svg
          className="w-12 h-12"
          fill="none"
    ...
    },
    {
      ...
      description:
        "High-quality diving equipment available for rent, maintained to the highest safety standards.",
      icon: (
        <svg
          className="w-12 h-12"
          fill="none"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              <div className="text-ocean-600 mb-4">{service.icon}</div>
